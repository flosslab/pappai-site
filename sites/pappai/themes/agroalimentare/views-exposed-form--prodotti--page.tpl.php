     ...
     <div class="views-exposed-widgets clearfix">
           <div class="row">
              <div class="views-widget col-md-12">
                  ...
                  <?php $label_to_print = $widgets["filter-title"]->widget;
                  $label_to_print = str_replace(' type="text" ', ' type="text" placeholder="'.$widgets["filter-title"]->label.'" ',$label_to_print);
                  $widgets["filter-title"]->widget=$label_to_print;
                  print $widgets["filter-title"]->widget;
                  ?>
              </div>
